...
class PriceComparison extends Component {
  ...
  showBestRate = (shapeshiftRate, changellyRate, nexchangeRate) => {
    ...
    if (info[idx] === 'nexchange') {
      imgUrl = '/img/prices/logo-icon.png';
    }
  ...
  fetchRates = () => {
    axios
      ...
      .then(
        axios.spread((btceth, btcltc, dogebtc, ethltc, dogeeth, dogeltc) => {
          this.setState(
            {
              nexchange: {
                ...
                <table className="table">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <img src="/img/prices/logo-icon.png" alt="unicrypto" />
                      </th>
                      <th>
                        <img src="/img/prices/shapeshift.png" width="60" alt="Shapeshift" />
                      </th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.btceth} BTC {this.priceDiff(this.state.nexchange.btceth, this.state.shapeshift.btceth)}
                      </td>
                      <td>
                       <img src="/img/prices/uno.png" alt="unicrypto" />
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.dogeeth} DOGE {this.priceDiff(this.state.nexchange.dogeeth, this.state.shapeshift.dogeeth)}
                      </td>
                      <td>
                        <img src="/img/prices/uno.png" alt="unicrypto" />
                      </td>
                      <td>
                        {this.showBestRate(this.state.shapeshift.dogeeth, this.state.changelly.dogeeth, this.state.nexchange.dogeeth)}
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.btcltc} BTC {this.priceDiff(this.state.nexchange.btcltc, this.state.shapeshift.btcltc)}
                      </td>
                      <td>
                       <img src="/img/prices/uno.png" alt="unicrypto" />
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.ethltc} ETH {this.priceDiff(this.state.nexchange.ethltc, this.state.shapeshift.ethltc)}
                      </td>
                      <td>
                       <img src="/img/prices/uno.png" alt="unicrypto" />
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.dogeltc} DOGE {this.priceDiff(this.state.nexchange.dogeltc, this.state.shapeshift.dogeltc)}
                      </td>
                      <td>
                       <img src="/img/prices/uno.png" alt="unicrypto" />
                      </td>
                      <td>
                        {this.showBestRate(this.state.shapeshift.dogeltc, this.state.changelly.dogeltc, this.state.nexchange.dogeltc)}
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.dogebtc} DOGE {this.priceDiff(this.state.nexchange.dogebtc, this.state.shapeshift.dogebtc)}
                      </td>
                      <td>
                       <img src="/img/prices/uno.png" alt="unicrypto" />
                      </td>
                      <td>
                        {this.showBestRate(this.state.shapeshift.dogebtc, this.state.changelly.dogebtc, this.state.nexchange.dogebtc)}
                      </td>
                    </tr>
                  </tbody>
                </table>
